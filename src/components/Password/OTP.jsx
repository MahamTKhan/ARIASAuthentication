...
import AuthNavbar from "../Authorization/AuthorizationNavbar";
      ...
      <div className="max-w-md w-full mx-auto p-6 bg-white rounded shadow-md">
        <form className="px-4 py-6">
          ...
          <div className="flex items-center justify-center">
            <button
              className="bg-white hover:bg-green-300 text-black py-2 px-6 rounded focus:outline-none focus:shadow-outline"
              type="button"
            ...
            <a
              className="inline-block align-baseline text-black hover:text-teal-800 ml-4"
              href="#"
